        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.hm.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.hms.update", [$hm->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            <label class="required" for="name">{{ trans('cruds.hm.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $hm->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group {{ $errors->has('username') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="username" id="username" value="{{ old('username', $hm->username) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="address" id="address">{!! old('address', $hm->address) !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="email" name="email" id="email" value="{{ old('email', $hm->email) }}" required>
                            @if($errors->has('email'))
                        ...
                        <div class="form-group {{ $errors->has('connection_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="connection_date" id="connection_date" value="{{ old('connection_date', $hm->connection_date) }}">
                        ...
                        <div class="form-group {{ $errors->has('network_ip') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="network_ip" id="network_ip" value="{{ old('network_ip', $hm->network_ip) }}">
                        ...
                        <div class="form-group {{ $errors->has('pathology_ip') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="pathology_ip" id="pathology_ip" value="{{ old('pathology_ip', $hm->pathology_ip) }}">
                        ...
                        <div class="form-group {{ $errors->has('reception_ip') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="reception_ip" id="reception_ip" value="{{ old('reception_ip', $hm->reception_ip) }}">
                        ...
                        <div class="form-group {{ $errors->has('xray_ip') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="xray_ip" id="xray_ip" value="{{ old('xray_ip', $hm->xray_ip) }}">
                        ...
                        <div class="form-group {{ $errors->has('ultrasonography_ip') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="ultrasonography_ip" id="ultrasonography_ip" value="{{ old('ultrasonography_ip', $hm->ultrasonography_ip) }}">
                        ...
                        <div class="form-group {{ $errors->has('admin_ip') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="admin_ip" id="admin_ip" value="{{ old('admin_ip', $hm->admin_ip) }}">
                        ...
                        <div class="form-group {{ $errors->has('chairman_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="chairman_name" id="chairman_name" value="{{ old('chairman_name', $hm->chairman_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('chairman_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="chairman_number" id="chairman_number" value="{{ old('chairman_number', $hm->chairman_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('md_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="md_name" id="md_name" value="{{ old('md_name', $hm->md_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('md_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="md_number" id="md_number" value="{{ old('md_number', $hm->md_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('director_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="director_name" id="director_name" value="{{ old('director_name', $hm->director_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('director_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="director_number" id="director_number" value="{{ old('director_number', $hm->director_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('manager_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="manager_name" id="manager_name" value="{{ old('manager_name', $hm->manager_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('manager_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="manager_number" id="manager_number" value="{{ old('manager_number', $hm->manager_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('am_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="am_name" id="am_name" value="{{ old('am_name', $hm->am_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('am_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="am_number" id="am_number" value="{{ old('am_number', $hm->am_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('reception_all_numbers') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="reception_all_numbers" id="reception_all_numbers">{!! old('reception_all_numbers', $hm->reception_all_numbers) !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('ultra_sonogram_assistant_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="ultra_sonogram_assistant_name" id="ultra_sonogram_assistant_name" value="{{ old('ultra_sonogram_assistant_name', $hm->ultra_sonogram_assistant_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('ultra_sonogram_assistant_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="ultra_sonogram_assistant_number" id="ultra_sonogram_assistant_number" value="{{ old('ultra_sonogram_assistant_number', $hm->ultra_sonogram_assistant_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('medical_technologist_lab_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="medical_technologist_lab_name" id="medical_technologist_lab_name" value="{{ old('medical_technologist_lab_name', $hm->medical_technologist_lab_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('medical_technologist_lab_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="medical_technologist_lab_number" id="medical_technologist_lab_number" value="{{ old('medical_technologist_lab_number', $hm->medical_technologist_lab_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('medical_technologist_xray_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="medical_technologist_xray_name" id="medical_technologist_xray_name" value="{{ old('medical_technologist_xray_name', $hm->medical_technologist_xray_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('medical_technologist_xray_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="medical_technologist_xray_number" id="medical_technologist_xray_number" value="{{ old('medical_technologist_xray_number', $hm->medical_technologist_xray_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('accounts_department_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="accounts_department_name" id="accounts_department_name" value="{{ old('accounts_department_name', $hm->accounts_department_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('accounts_department_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="accounts_department_number" id="accounts_department_number" value="{{ old('accounts_department_number', $hm->accounts_department_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('receptionist_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="receptionist_name" id="receptionist_name" value="{{ old('receptionist_name', $hm->receptionist_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('receptionist_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="receptionist_number" id="receptionist_number" value="{{ old('receptionist_number', $hm->receptionist_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('accountant_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="accountant_name" id="accountant_name" value="{{ old('accountant_name', $hm->accountant_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('accountant_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="accountant_number" id="accountant_number" value="{{ old('accountant_number', $hm->accountant_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('bill_send_mail') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="email" name="bill_send_mail" id="bill_send_mail" value="{{ old('bill_send_mail', $hm->bill_send_mail) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('previous_company') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="previous_company" id="previous_company" value="{{ old('previous_company', $hm->previous_company) }}">
                        ...
                        <div class="form-group {{ $errors->has('it_person_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="it_person_name" id="it_person_name" value="{{ old('it_person_name', $hm->it_person_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('it_person_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="it_person_number" id="it_person_number" value="{{ old('it_person_number', $hm->it_person_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('installed_by') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="installed_by" id="installed_by" value="{{ old('installed_by', $hm->installed_by) }}">
                        ...
                        <div class="form-group {{ $errors->has('annual_maintenance_charge') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="annual_maintenance_charge" id="annual_maintenance_charge" value="{{ old('annual_maintenance_charge', $hm->annual_maintenance_charge) }}">
                        ...
                        <div class="form-group {{ $errors->has('connection_status') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="connection_status" id="connection_status" required>
                                ...
                                @foreach(App\Models\Hm::CONNECTION_STATUS_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('connection_status', $hm->connection_status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('conncetion_status_reason') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="conncetion_status_reason" id="conncetion_status_reason" value="{{ old('conncetion_status_reason', $hm->conncetion_status_reason) }}">
                        ...
                        <div class="form-group {{ $errors->has('connection_type') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="connection_type" id="connection_type" required>
                                ...
                                @foreach(App\Models\Hm::CONNECTION_TYPE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('connection_type', $hm->connection_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
