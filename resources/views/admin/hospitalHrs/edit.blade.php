        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.hospitalHr.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.hospital-hrs.update", [$hospitalHr->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('hopital_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="hopital_name" id="hopital_name" value="{{ old('hopital_name', $hospitalHr->hopital_name) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('chairman_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="chairman_name" id="chairman_name" value="{{ old('chairman_name', $hospitalHr->chairman_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('chairman_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="chairman_number" id="chairman_number" value="{{ old('chairman_number', $hospitalHr->chairman_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('md_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="md_name" id="md_name" value="{{ old('md_name', $hospitalHr->md_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('md_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="md_number" id="md_number" value="{{ old('md_number', $hospitalHr->md_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('director_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="director_name" id="director_name" value="{{ old('director_name', $hospitalHr->director_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('director_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="director_number" id="director_number" value="{{ old('director_number', $hospitalHr->director_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('manager_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="manager_name" id="manager_name" value="{{ old('manager_name', $hospitalHr->manager_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('manager_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="manager_number" id="manager_number" value="{{ old('manager_number', $hospitalHr->manager_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('am_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="am_name" id="am_name" value="{{ old('am_name', $hospitalHr->am_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('am_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="am_number" id="am_number" value="{{ old('am_number', $hospitalHr->am_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('reception_details') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="reception_details" id="reception_details">{!! old('reception_details', $hospitalHr->reception_details) !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('accountant_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="accountant_name" id="accountant_name" value="{{ old('accountant_name', $hospitalHr->accountant_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('accountant_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="accountant_number" id="accountant_number" value="{{ old('accountant_number', $hospitalHr->accountant_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('mt_name_1') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="mt_name_1" id="mt_name_1" value="{{ old('mt_name_1', $hospitalHr->mt_name_1) }}">
                        ...
                        <div class="form-group {{ $errors->has('mt_number_1') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="mt_number_1" id="mt_number_1" value="{{ old('mt_number_1', $hospitalHr->mt_number_1) }}">
                        ...
                        <div class="form-group {{ $errors->has('mt_name_2') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="mt_name_2" id="mt_name_2" value="{{ old('mt_name_2', $hospitalHr->mt_name_2) }}">
                        ...
                        <div class="form-group {{ $errors->has('mt_number_2') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="mt_number_2" id="mt_number_2" value="{{ old('mt_number_2', $hospitalHr->mt_number_2) }}">
                        ...
                        <div class="form-group {{ $errors->has('mt_name_3') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="mt_name_3" id="mt_name_3" value="{{ old('mt_name_3', $hospitalHr->mt_name_3) }}">
                        ...
                        <div class="form-group {{ $errors->has('mt_number_3') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="mt_number_3" id="mt_number_3" value="{{ old('mt_number_3', $hospitalHr->mt_number_3) }}">
                        ...
                        <div class="form-group {{ $errors->has('mt_name_4') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="mt_name_4" id="mt_name_4" value="{{ old('mt_name_4', $hospitalHr->mt_name_4) }}">
                        ...
                        <div class="form-group {{ $errors->has('mt_number_4') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="mt_number_4" id="mt_number_4" value="{{ old('mt_number_4', $hospitalHr->mt_number_4) }}">
                        ...
                        <div class="form-group {{ $errors->has('mt_name_5') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="mt_name_5" id="mt_name_5" value="{{ old('mt_name_5', $hospitalHr->mt_name_5) }}">
                        ...
                        <div class="form-group {{ $errors->has('mt_number_5') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="mt_number_5" id="mt_number_5" value="{{ old('mt_number_5', $hospitalHr->mt_number_5) }}">
                        ...
                        <div class="form-group {{ $errors->has('ct_eng_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="ct_eng_name" id="ct_eng_name" value="{{ old('ct_eng_name', $hospitalHr->ct_eng_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('ct_eng_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="ct_eng_number" id="ct_eng_number" value="{{ old('ct_eng_number', $hospitalHr->ct_eng_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('it_person_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="it_person_name" id="it_person_name" value="{{ old('it_person_name', $hospitalHr->it_person_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('it_person_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="it_person_number" id="it_person_number" value="{{ old('it_person_number', $hospitalHr->it_person_number) }}">
