        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Leave">
                        <thead>
                            <tr>
                                <th width="10">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="search" strict="true">
                                        <option value>{{ trans('global.all') }}</option>
                                        @foreach(App\Models\Leave::TYPE_SELECT as $key => $item)
...
{ data: 'id', name: 'id' },
{ data: 'emp_name_full_name', name: 'emp_name.full_name' },
{ data: 'type', name: 'type' },
{ data: 'date', name: 'date' },
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Leave').DataTable(dtOverrideGlobals);
