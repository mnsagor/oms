                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.leaves.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('type') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="type" id="type" required>
                                ...
                                @foreach(App\Models\Leave::TYPE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('type', 'Casual Leave') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('type'))
                        ...
                        <div class="form-group {{ $errors->has('total_day') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="total_day" id="total_day" value="{{ old('total_day', '') }}" required>
