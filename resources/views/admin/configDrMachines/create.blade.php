        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.configDrMachine.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.config-dr-machines.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('hospital_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="hospital_name" id="hospital_name" value="{{ old('hospital_name', 'DR mahine For XXX Hospital') }}" required>
