        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.visitedHospital.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.visited-hospitals.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('is_online') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="is_online" id="is_online">
                                ...
                                @foreach(App\Models\VisitedHospital::IS_ONLINE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('is_online', 'Yes') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('visited_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="visited_date" id="visited_date" value="{{ old('visited_date') }}">
                        ...
                        <div class="form-group {{ $errors->has('visited_by') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="visited_by" id="visited_by" value="{{ old('visited_by', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('other_company_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="other_company_name" id="other_company_name" value="{{ old('other_company_name', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('other_company_price') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="other_company_price" id="other_company_price" value="{{ old('other_company_price', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('dealing_tech') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="dealing_tech" id="dealing_tech" value="{{ old('dealing_tech', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('dealing_tech_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="dealing_tech_number" id="dealing_tech_number" value="{{ old('dealing_tech_number', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('bill_send_email') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="email" name="bill_send_email" id="bill_send_email" value="{{ old('bill_send_email') }}">
