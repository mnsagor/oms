                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.inventories.update", [$inventory->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('purchase_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="purchase_date" id="purchase_date" value="{{ old('purchase_date', $inventory->purchase_date) }}">
                        ...
                        <div class="form-group {{ $errors->has('warrenty') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="warrenty" id="warrenty" value="{{ old('warrenty', $inventory->warrenty) }}">
                        ...
                        <div class="form-group {{ $errors->has('price') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="price" id="price" value="{{ old('price', $inventory->price) }}" required>
                            @if($errors->has('price'))
                        ...
                        <div class="form-group {{ $errors->has('credit') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="credit" id="credit" value="{{ old('credit', $inventory->credit) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('due') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="due" id="due" value="{{ old('due', $inventory->due) }}">
                            @if($errors->has('due'))
                        ...
                        <div class="form-group {{ $errors->has('is_damage') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="is_damage" id="is_damage" value="{{ old('is_damage', $inventory->is_damage) }}">
                        ...
                        <div class="form-group {{ $errors->has('stock_balance') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="stock_balance" id="stock_balance" value="{{ old('stock_balance', $inventory->stock_balance) }}">
                        ...
                        <div class="form-group {{ $errors->has('supplier_info') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="supplier_info" id="supplier_info">{!! old('supplier_info', $inventory->supplier_info) !!}</textarea>
