                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="search" strict="true">
                                            ...
                                            @foreach(App\Models\Modality::STATUS_SELECT as $key => $item)
                            ...
                            <tbody>
                                @foreach($modalities as $key => $modality)
                                    <tr data-entry-id="{{ $modality->id }}">
                                        ...
                                        <td>
                                            @can('modality_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('admin.modalities.show', $modality->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('modality_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('admin.modalities.edit', $modality->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('modality_delete')
                                                <form action="{{ route('admin.modalities.destroy', $modality->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
