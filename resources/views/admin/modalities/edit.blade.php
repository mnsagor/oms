                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.modalities.update", [$modality->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $modality->name) }}" required>
                            @if($errors->has('name'))
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('admin.modalities.storeCKEditorImages') }}', true);
