                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('full_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="full_name" id="full_name" value="{{ old('full_name', $user->full_name) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('father_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="father_name" id="father_name" value="{{ old('father_name', $user->father_name) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('mother_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="mother_name" id="mother_name" value="{{ old('mother_name', $user->mother_name) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('designation') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="designation" id="designation" value="{{ old('designation', $user->designation) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('mobile') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="mobile" id="mobile" value="{{ old('mobile', $user->mobile) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('salary_type') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="salary_type" id="salary_type" required>
                                ...
                                @foreach(App\Models\User::SALARY_TYPE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('salary_type', $user->salary_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('joining_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="joining_date" id="joining_date" value="{{ old('joining_date', $user->joining_date) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('salary') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="salary" id="salary" value="{{ old('salary', $user->salary) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('signature') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="signature" id="signature">{!! old('signature', $user->signature) !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="address" id="address">{!! old('address', $user->address) !!}</textarea>
