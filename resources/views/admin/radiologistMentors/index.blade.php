    ...
    @can('radiologist_mentor_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                ...
                @include('csvImport.modal', ['model' => 'RadiologistMentor', 'route' => 'admin.radiologist-mentors.parseCsvImport'])
            </div>
        </div>
    @endcan
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-RadiologistMentor">
                        <thead>
                            <tr>
                                <th width="10">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="search">
                                        ...
                                        @foreach($hospital_mentors as $key => $item)
                                ...
                                <td>
                                    <select class="search" strict="true">
                                        <option value>{{ trans('global.all') }}</option>
                                        @foreach(App\Models\RadiologistMentor::STATUS_SELECT as $key => $item)
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.radiologist-mentors.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-RadiologistMentor').DataTable(dtOverrideGlobals);
