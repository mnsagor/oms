        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.priceAgreementPolicy.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.price-agreement-policies.update", [$priceAgreementPolicy->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            <label class="required" for="name">{{ trans('cruds.priceAgreementPolicy.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $priceAgreementPolicy->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group {{ $errors->has('xray') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="xray" id="xray" value="{{ old('xray', $priceAgreementPolicy->xray) }}">
                            @if($errors->has('xray'))
                        ...
                        <div class="form-group {{ $errors->has('xray_single') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="xray_single" id="xray_single" value="{{ old('xray_single', $priceAgreementPolicy->xray_single) }}">
                        ...
                        <div class="form-group {{ $errors->has('xray_both') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="xray_both" id="xray_both" value="{{ old('xray_both', $priceAgreementPolicy->xray_both) }}">
                        ...
                        <div class="form-group {{ $errors->has('xray_contrast') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="xray_contrast" id="xray_contrast" value="{{ old('xray_contrast', $priceAgreementPolicy->xray_contrast) }}">
                        ...
                        <div class="form-group {{ $errors->has('ct') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="ct" id="ct" value="{{ old('ct', $priceAgreementPolicy->ct) }}">
                            @if($errors->has('ct'))
                        ...
                        <div class="form-group {{ $errors->has('ct_brain') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="ct_brain" id="ct_brain" value="{{ old('ct_brain', $priceAgreementPolicy->ct_brain) }}">
                        ...
                        <div class="form-group {{ $errors->has('ct_chest') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="ct_chest" id="ct_chest" value="{{ old('ct_chest', $priceAgreementPolicy->ct_chest) }}">
                        ...
                        <div class="form-group {{ $errors->has('ct_other') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="ct_other" id="ct_other" value="{{ old('ct_other', $priceAgreementPolicy->ct_other) }}">
                        ...
                        <div class="form-group {{ $errors->has('whole_abdomen') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="whole_abdomen" id="whole_abdomen" value="{{ old('whole_abdomen', $priceAgreementPolicy->whole_abdomen) }}">
                        ...
                        <div class="form-group {{ $errors->has('urogram') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="urogram" id="urogram" value="{{ old('urogram', $priceAgreementPolicy->urogram) }}">
                        ...
                        <div class="form-group {{ $errors->has('mri') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="mri" id="mri" value="{{ old('mri', $priceAgreementPolicy->mri) }}">
                            @if($errors->has('mri'))
                        ...
                        <div class="form-group {{ $errors->has('mri_brain') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="mri_brain" id="mri_brain" value="{{ old('mri_brain', $priceAgreementPolicy->mri_brain) }}">
                        ...
                        <div class="form-group {{ $errors->has('mri_spine') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="mri_spine" id="mri_spine" value="{{ old('mri_spine', $priceAgreementPolicy->mri_spine) }}">
                        ...
                        <div class="form-group {{ $errors->has('mri_other') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="mri_other" id="mri_other" value="{{ old('mri_other', $priceAgreementPolicy->mri_other) }}">
