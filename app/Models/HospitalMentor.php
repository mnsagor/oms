...
class HospitalMentor extends Model implements HasMedia
{
    use SoftDeletes;
    use HasMediaTrait;
    use Auditable;
    ...
    public function hospitalNameRadiologistMentors()
    {
        return $this->hasMany(RadiologistMentor::class, 'hospital_name_id', 'id');
    }
