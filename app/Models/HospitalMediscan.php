...
class HospitalMediscan extends Model implements HasMedia
{
    use SoftDeletes;
    use HasMediaTrait;
    use Auditable;
    ...
    public $table = 'hospital_mediscans';
    ...
    public function hospitalNameRadiologistMediscans()
    {
        return $this->hasMany(RadiologistMediscan::class, 'hospital_name_id', 'id');
    }
